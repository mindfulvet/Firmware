...
#define STRING_CONFIG_H_AUTHOR "(llind.xyz, Ender-5 Pro)" // Who made the changes.
...
#define PREHEAT_3_TEMP_HOTEND   235     // Good balance for flow and layer bonding
#define PREHEAT_3_TEMP_BED       75     // Helps with first-layer adhesion without warping
#define PREHEAT_3_TEMP_CHAMBER   35     // Optional—keeps ambient stable
#define PREHEAT_3_FAN_SPEED     100     // Lower fan speed to avoid layer separation
